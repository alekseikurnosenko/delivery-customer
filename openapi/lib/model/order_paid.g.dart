...
part of 'order_paid.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<OrderPaid> _$orderPaidSerializer = new _$OrderPaidSerializer();

class _$OrderPaidSerializer implements StructuredSerializer<OrderPaid> {
  @override
  final Iterable<Type> types = const [OrderPaid, _$OrderPaid];
  @override
  final String wireName = 'OrderPaid';

  @override
  Iterable<Object> serialize(Serializers serializers, OrderPaid object,
  ...
  @override
  OrderPaid deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new OrderPaidBuilder();
...
class _$OrderPaid extends OrderPaid {
  @override
  final String userId;
  @override
  ...
  factory _$OrderPaid([void Function(OrderPaidBuilder) updates]) =>
      (new OrderPaidBuilder()..update(updates)).build();
  ...
  @override
  OrderPaid rebuild(void Function(OrderPaidBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  OrderPaidBuilder toBuilder() => new OrderPaidBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is OrderPaid &&
        userId == other.userId &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('OrderPaid')
          ..add('userId', userId)
          ..add('orderId', orderId)
...
class OrderPaidBuilder implements Builder<OrderPaid, OrderPaidBuilder> {
  _$OrderPaid _$v;
  ...
  @override
  void replace(OrderPaid other) {
    if (other == null) {
      throw new ArgumentError.notNull('other');
    }
    _$v = other as _$OrderPaid;
  }

  @override
  void update(void Function(OrderPaidBuilder) updates) {
    if (updates != null) updates(this);
  }

  @override
  _$OrderPaid build() {
    _$OrderPaid _$result;
    try {
      _$result = _$v ??
          new _$OrderPaid._(
              userId: userId,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'OrderPaid', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
